...
ResultSet rs;
rs = stmt.executeQuery("SELECT firstName, password FROM Users WHERE username='" +userid+ "';");
if(rs.next()){
...
response.sendRedirect("customerportal.jsp");
    ...
    out.println("Invalid Username or Password. <a href='customerlogin.jsp'>Please try again</a>");
}
} catch (Exception x) {
out.println(x);
out.println("error");
